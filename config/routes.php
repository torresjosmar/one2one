...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/listado', ['controller' => 'Pages', 'action' => 'lista', 'lista']);
    $routes->connect('/como-funciona', ['controller' => 'Pages', 'action' => 'funciona', 'funciona']);
    $routes->connect('/busqueda', ['controller' => 'Pages', 'action' => 'busqueda']);
